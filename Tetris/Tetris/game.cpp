...
Game::Game()
{
    ...
    music = LoadMusicStream("C:/Users/Administrator/source/repos/Tetris/Sounds/funny.mp3");//Background Music While Playing
    PlayMusicStream(music);//Used to start playing a music stream.
    rotateSound = LoadSound("C:/Users/Administrator/source/repos/Tetris/Sounds/rotate.mp3");//Sound effect while rotating the block
    clearSound = LoadSound("C:/Users/Administrator/source/repos/Tetris/Sounds/clear.mp3");//Sound effect when the block clear
}
